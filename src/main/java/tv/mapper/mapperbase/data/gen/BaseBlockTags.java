...
public class BaseBlockTags extends BlockTagsProvider
{
    ...
    public void registerTags()
    {
        ...
        this.getBuilder(BlockTags.FENCES).add(BaseBlocks.STEEL_FENCE, BaseBlocks.CONCRETE_FENCE);
        this.getBuilder(Tags.Blocks.FENCES).add(BaseBlocks.STEEL_FENCE, BaseBlocks.CONCRETE_FENCE);
