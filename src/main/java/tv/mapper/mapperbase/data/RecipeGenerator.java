...
public class RecipeGenerator extends BaseRecipeProvider
{

    public RecipeGenerator(PackOutput pOutput, CompletableFuture<Provider> pRegistries, String name)
    {
    ...
    {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MB_Items.RIVET.get()).requires(BaseTags.Items.NUGGETS_STEEL).requires(BaseTags.Items.FLATTER_HAMMERS).unlockedBy("has_steel_nugget", has(BaseTags.Items.NUGGETS_STEEL)).unlockedBy("has_flatter_hammer", has(BaseTags.Items.FLATTER_HAMMERS)).save(output);
        ...
        // Steel gear
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, MB_Items.STEEL_AXE).pattern("aa").pattern("as").pattern(" s").define('a', BaseTags.Items.INGOTS_STEEL).define('s', BaseTags.Items.RODS_IRON).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).unlockedBy("has_iron_rod", has(BaseTags.Items.RODS_IRON)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, MB_Items.STEEL_PICKAXE).pattern("aaa").pattern(" s ").pattern(" s ").define('a', BaseTags.Items.INGOTS_STEEL).define('s', BaseTags.Items.RODS_IRON).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).unlockedBy("has_iron_rod", has(BaseTags.Items.RODS_IRON)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, MB_Items.STEEL_SHOVEL).pattern("a").pattern("s").pattern("s").define('a', BaseTags.Items.INGOTS_STEEL).define('s', BaseTags.Items.RODS_IRON).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).unlockedBy("has_iron_rod", has(BaseTags.Items.RODS_IRON)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, MB_Items.STEEL_HOE).pattern("aa").pattern(" s").pattern(" s").define('a', BaseTags.Items.INGOTS_STEEL).define('s', BaseTags.Items.RODS_IRON).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).unlockedBy("has_iron_rod", has(BaseTags.Items.RODS_IRON)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MB_Items.STEEL_SWORD).pattern("a").pattern("a").pattern("s").define('a', BaseTags.Items.INGOTS_STEEL).define('s', BaseTags.Items.RODS_IRON).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).unlockedBy("has_iron_rod", has(BaseTags.Items.RODS_IRON)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MB_Items.STEEL_HELMET).pattern("aaa").pattern("a a").define('a', BaseTags.Items.INGOTS_STEEL).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MB_Items.STEEL_CHESTPLATE).pattern("a a").pattern("aaa").pattern("aaa").define('a', BaseTags.Items.INGOTS_STEEL).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MB_Items.STEEL_LEGGINGS).pattern("aaa").pattern("a a").pattern("a a").define('a', BaseTags.Items.INGOTS_STEEL).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).save(output);
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, MB_Items.STEEL_BOOTS).pattern("a a").pattern("a a").define('a', BaseTags.Items.INGOTS_STEEL).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).save(output);

        SimpleCookingRecipeBuilder.blasting(Ingredient.of(MB_Items.STEEL_PICKAXE, MB_Items.STEEL_SHOVEL, MB_Items.STEEL_AXE, MB_Items.STEEL_HOE, MB_Items.STEEL_SWORD, MB_Items.STEEL_HELMET, MB_Items.STEEL_CHESTPLATE, MB_Items.STEEL_LEGGINGS, MB_Items.STEEL_BOOTS), RecipeCategory.MISC, MB_Items.STEEL_NUGGET, 0.1f, 130).unlockedBy("has_steel_nugget", has(BaseTags.Items.NUGGETS_STEEL)).unlockedBy("has_steel_pickaxe", has(MB_Items.STEEL_PICKAXE)).unlockedBy("has_steel_shovel", has(MB_Items.STEEL_SHOVEL)).unlockedBy("has_steel_axe", has(MB_Items.STEEL_AXE)).unlockedBy("has_steel_hoe", has(MB_Items.STEEL_HOE)).unlockedBy("has_steel_sword", has(MB_Items.STEEL_SWORD)).unlockedBy("has_steel_helmet", has(MB_Items.STEEL_HELMET)).unlockedBy("has_steel_chestplate", has(MB_Items.STEEL_CHESTPLATE)).unlockedBy("has_steel_leggings", has(MB_Items.STEEL_LEGGINGS)).unlockedBy("has_steel_boots", has(MB_Items.STEEL_BOOTS)).save(output, MapperBase.MODID + ":steel_nugget_from_recycling");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MB_Items.STEEL_ROD.get(), 4).pattern("x").pattern("x").define('x', BaseTags.Items.INGOTS_STEEL).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).save(output);

        // Metal plates
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MB_Items.IRON_PLATE.get()).requires(Tags.Items.INGOTS_IRON).requires(BaseTags.Items.FLATTER_HAMMERS).unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON)).unlockedBy("has_flatter_hammer", has(BaseTags.Items.FLATTER_HAMMERS)).save(output);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, MB_Items.STEEL_PLATE.get()).requires(BaseTags.Items.INGOTS_STEEL).requires(BaseTags.Items.FLATTER_HAMMERS).unlockedBy("has_steel_ingot", has(BaseTags.Items.INGOTS_STEEL)).unlockedBy("has_flatter_hammer", has(BaseTags.Items.FLATTER_HAMMERS)).save(output);
