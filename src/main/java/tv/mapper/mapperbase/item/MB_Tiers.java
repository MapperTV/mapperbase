...
public class MB_Tiers
{
    ...
    public static final Tier STEEL_BASE_TIERS = new SimpleTier(BlockTags.INCORRECT_FOR_IRON_TOOL, 1024, 7f, 2.5f, 8, () -> Ingredient.of(BaseTags.Items.INGOTS_STEEL));
    ...
    }), 9, SoundEvents.ARMOR_EQUIP_GENERIC, () -> Ingredient.of(BaseTags.Items.INGOTS_STEEL), List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(MapperBase.MODID, "steel"))), 0, 0));
}
