...
public class BaseItems
{
    ...
    public static final RegistryObject<Item> CONCRETE_ITEM = ITEMS.register("concrete", () -> new BlockItem(BaseBlocks.CONCRETE.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> CONCRETE_STAIRS_ITEM = ITEMS.register("concrete_stairs", () -> new BlockItem(BaseBlocks.CONCRETE_STAIRS.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> CONCRETE_SLAB_ITEM = ITEMS.register("concrete_slab", () -> new BlockItem(BaseBlocks.CONCRETE_SLAB.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> CONCRETE_WALL_ITEM = ITEMS.register("concrete_wall", () -> new BlockItem(BaseBlocks.CONCRETE_WALL.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> CONCRETE_PRESSURE_PLATE_ITEM = ITEMS.register("concrete_pressure_plate", () -> new BlockItem(BaseBlocks.CONCRETE_PRESSURE_PLATE.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> CONCRETE_FENCE_ITEM = ITEMS.register("concrete_fence", () -> new BlockItem(BaseBlocks.CONCRETE_FENCE.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> CONCRETE_FENCE_GATE_ITEM = ITEMS.register("concrete_fence_gate", () -> new BlockItem(BaseBlocks.CONCRETE_FENCE_GATE.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));

    public static final RegistryObject<Item> RAW_BITUMEN = ITEMS.register("raw_bitumen", () -> new Item(new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> BITUMEN_ORE_ITEM = ITEMS.register("bitumen_ore", () -> new BlockItem(BaseBlocks.BITUMEN_ORE.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> BITUMEN_ITEM = ITEMS.register("bitumen_block", () -> new BlockItem(BaseBlocks.BITUMEN_BLOCK.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> BITUMINOUS_COAL = ITEMS.register("bituminous_coal", () -> new FuelItem(new Item.Properties().tab(BaseGroups.MAPPERBASE), 250));

    public static final RegistryObject<Item> ASPHALT_ITEM = ITEMS.register("asphalt", () -> new BlockItem(BaseBlocks.ASPHALT.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> ASPHALT_STAIRS_ITEM = ITEMS.register("asphalt_stairs", () -> new BlockItem(BaseBlocks.ASPHALT_STAIRS.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> ASPHALT_SLAB_ITEM = ITEMS.register("asphalt_slab", () -> new BlockItem(BaseBlocks.ASPHALT_SLAB.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> ASPHALT_PRESSURE_PLATE_ITEM = ITEMS.register("asphalt_pressure_plate", () -> new BlockItem(BaseBlocks.ASPHALT_PRESSURE_PLATE.get(), new Item.Properties().tab(BaseGroups.MAPPERBASE)));
    ...
    public static final RegistryObject<Item> STEEL_AXE = ITEMS.register("steel_axe", () -> new AxeItem(BaseItemTier.STEEL, 6.0F, -3.0F, (new Item.Properties()).tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> STEEL_PICKAXE = ITEMS.register("steel_pickaxe", () -> new PickaxeItem(BaseItemTier.STEEL, 1, -2.8F, (new Item.Properties()).tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> STEEL_SHOVEL = ITEMS.register("steel_shovel", () -> new ShovelItem(BaseItemTier.STEEL, 1.5F, -3.0F, (new Item.Properties()).tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> STEEL_HOE = ITEMS.register("steel_hoe", () -> new HoeItem(BaseItemTier.STEEL, -2, -0.0F, (new Item.Properties()).tab(BaseGroups.MAPPERBASE)));
    public static final RegistryObject<Item> STEEL_SWORD = ITEMS.register("steel_sword", () -> new SwordItem(BaseItemTier.STEEL, 3, -2.4F, (new Item.Properties()).tab(BaseGroups.MAPPERBASE)));
